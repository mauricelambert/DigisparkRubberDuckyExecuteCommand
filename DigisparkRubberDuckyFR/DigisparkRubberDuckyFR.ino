...
const PROGMEM uint8_t payload [PAYLOAD_LENGTH] = {
    KEY_P, 0x00, KEY_O, 0x00, KEY_Z, 0x00, KEY_E, 0x00, KEY_R, 0x00, KEY_S, 0x00, KEY_H, 0x00, KEY_E, 0x00, KEY_L, 0x00, KEY_L, 0x00, KEY_SPACE, 0x00, KEY_6, 0x00, KEY_Z, 0x00, KEY_I, 0x00, KEY_N, 0x00, KEY_D, 0x00, KEY_O, 0x00, KEY_Z, 0x00, KEY_S, 0x00, KEY_T, 0x00, KEY_Y, 0x00, KEY_L, 0x00, KEY_E, 0x00, KEY_SPACE, 0x00, KEY_H, 0x00, KEY_I, 0x00, KEY_D, 0x00, KEY_D, 0x00, KEY_E, 0x00, KEY_N, 0x00, KEY_SPACE, 0x00, KEY_6, 0x00, KEY_C, MODIFIERKEY_SHIFT, KEY_O, 0x00, KEY_SEMICOLON, 0x00, KEY_SEMICOLON, 0x00, KEY_Q, 0x00, KEY_N, 0x00, KEY_D, 0x00, KEY_SPACE, 0x00, KEY_3, 0x00, KEY_I, 0x00, KEY_E, 0x00, KEY_X, 0x00, KEY_5, 0x00, KEY_I, 0x00, KEY_Z, 0x00, KEY_R, 0x00, KEY_SPACE, 0x00, KEY_6, 0x00, KEY_U, MODIFIERKEY_SHIFT, KEY_R, 0x00, KEY_I, 0x00, KEY_SPACE, 0x00, KEY_4, 0x00, KEY_H, 0x00, KEY_T, 0x00, KEY_T, 0x00, KEY_P, 0x00, KEY_S, 0x00, KEY_PERIOD, 0x00, KEY_PERIOD, MODIFIERKEY_SHIFT, KEY_PERIOD, MODIFIERKEY_SHIFT, KEY_P, 0x00, KEY_Q, 0x00, KEY_S, 0x00, KEY_T, 0x00, KEY_E, 0x00, KEY_B, 0x00, KEY_I, 0x00, KEY_N, 0x00, KEY_COMMA, MODIFIERKEY_SHIFT, KEY_C, 0x00, KEY_O, 0x00, KEY_SEMICOLON, 0x00, KEY_PERIOD, MODIFIERKEY_SHIFT, KEY_R, 0x00, KEY_Q, 0x00, KEY_Z, 0x00, KEY_PERIOD, MODIFIERKEY_SHIFT, KEY_B, 0x00, KEY_C, 0x00, KEY_J, 0x00, KEY_H, 0x00, KEY_N, 0x00, KEY_Y, MODIFIERKEY_SHIFT, KEY_K, MODIFIERKEY_SHIFT, KEY_G, MODIFIERKEY_SHIFT, KEY_4, 0x00, KEY_SPACE, 0x00, KEY_6, 0x00, KEY_U, MODIFIERKEY_SHIFT, KEY_S, 0x00, KEY_E, 0x00, KEY_B, MODIFIERKEY_SHIFT, KEY_Q, 0x00, KEY_S, 0x00, KEY_I, 0x00, KEY_C, 0x00, KEY_P, MODIFIERKEY_SHIFT, KEY_Q, 0x00, KEY_R, 0x00, KEY_S, 0x00, KEY_I, 0x00, KEY_N, 0x00, KEY_G, 0x00, KEY_MINUS, 0x00, KEY_COMMA, MODIFIERKEY_SHIFT, KEY_C, MODIFIERKEY_SHIFT, KEY_O, 0x00, KEY_N, 0x00, KEY_T, 0x00, KEY_E, 0x00, KEY_N, 0x00, KEY_T, 0x00, KEY_3, 0x00
};
