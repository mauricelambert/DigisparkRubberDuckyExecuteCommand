...
#define ASCII_21 KEY_1, MODIFIERKEY_SHIFT
#define ASCII_22 KEY_QUOTE, MODIFIERKEY_SHIFT
#define ASCII_23 KEY_3, MODIFIERKEY_SHIFT
#define ASCII_24 KEY_4, MODIFIERKEY_SHIFT
#define ASCII_25 KEY_5, MODIFIERKEY_SHIFT
#define ASCII_26 KEY_7, MODIFIERKEY_SHIFT
#define ASCII_27 KEY_QUOTE
#define ASCII_28 KEY_9, MODIFIERKEY_SHIFT
#define ASCII_29 KEY_0, MODIFIERKEY_SHIFT
#define ASCII_2A KEY_8, MODIFIERKEY_SHIFT
...
#define ASCII_3A KEY_SEMICOLON, MODIFIERKEY_SHIFT
#define ASCII_3B KEY_SEMICOLON
#define ASCII_3C KEY_COMMA, MODIFIERKEY_SHIFT
#define ASCII_3D KEY_EQUAL
#define ASCII_3E KEY_PERIOD, MODIFIERKEY_SHIFT
#define ASCII_3F KEY_SLASH, MODIFIERKEY_SHIFT
#define ASCII_40 KEY_2, MODIFIERKEY_SHIFT
#define ASCII_41 KEY_A, MODIFIERKEY_SHIFT
...
#define ASCII_7B KEY_LEFT_BRACE, MODIFIERKEY_SHIFT
#define ASCII_7C KEY_BACKSLASH, MODIFIERKEY_SHIFT
#define ASCII_7D KEY_RIGHT_BRACE, MODIFIERKEY_SHIFT
#define ASCII_7E KEY_TILDE, MODIFIERKEY_SHIFT
#define ASCII_7F KEY_BACKSPACE
#define PAYLOAD_LENGTH 232
const PROGMEM uint8_t payload [PAYLOAD_LENGTH] = {
    KEY_P, 0x00, KEY_O, 0x00, KEY_W, 0x00, KEY_E, 0x00, KEY_R, 0x00, KEY_S, 0x00, KEY_H, 0x00, KEY_E, 0x00, KEY_L, 0x00, KEY_L, 0x00, KEY_SPACE, 0x00, KEY_MINUS, 0x00, KEY_W, 0x00, KEY_I, 0x00, KEY_N, 0x00, KEY_D, 0x00, KEY_O, 0x00, KEY_W, 0x00, KEY_S, 0x00, KEY_T, 0x00, KEY_Y, 0x00, KEY_L, 0x00, KEY_E, 0x00, KEY_SPACE, 0x00, KEY_H, 0x00, KEY_I, 0x00, KEY_D, 0x00, KEY_D, 0x00, KEY_E, 0x00, KEY_N, 0x00, KEY_SPACE, 0x00, KEY_MINUS, 0x00, KEY_C, MODIFIERKEY_SHIFT, KEY_O, 0x00, KEY_M, 0x00, KEY_M, 0x00, KEY_A, 0x00, KEY_N, 0x00, KEY_D, 0x00, KEY_SPACE, 0x00, KEY_QUOTE, MODIFIERKEY_SHIFT, KEY_I, 0x00, KEY_E, 0x00, KEY_X, 0x00, KEY_9, MODIFIERKEY_SHIFT, KEY_I, 0x00, KEY_W, 0x00, KEY_R, 0x00, KEY_SPACE, 0x00, KEY_MINUS, 0x00, KEY_U, MODIFIERKEY_SHIFT, KEY_R, 0x00, KEY_I, 0x00, KEY_SPACE, 0x00, KEY_QUOTE, 0x00, KEY_H, 0x00, KEY_T, 0x00, KEY_T, 0x00, KEY_P, 0x00, KEY_S, 0x00, KEY_SEMICOLON, MODIFIERKEY_SHIFT, KEY_SLASH, 0x00, KEY_SLASH, 0x00, KEY_P, 0x00, KEY_A, 0x00, KEY_S, 0x00, KEY_T, 0x00, KEY_E, 0x00, KEY_B, 0x00, KEY_I, 0x00, KEY_N, 0x00, KEY_PERIOD, 0x00, KEY_C, 0x00, KEY_O, 0x00, KEY_M, 0x00, KEY_SLASH, 0x00, KEY_R, 0x00, KEY_A, 0x00, KEY_W, 0x00, KEY_SLASH, 0x00, KEY_B, 0x00, KEY_C, 0x00, KEY_J, 0x00, KEY_H, 0x00, KEY_N, 0x00, KEY_Y, MODIFIERKEY_SHIFT, KEY_K, MODIFIERKEY_SHIFT, KEY_G, MODIFIERKEY_SHIFT, KEY_QUOTE, 0x00, KEY_SPACE, 0x00, KEY_MINUS, 0x00, KEY_U, MODIFIERKEY_SHIFT, KEY_S, 0x00, KEY_E, 0x00, KEY_B, MODIFIERKEY_SHIFT, KEY_A, 0x00, KEY_S, 0x00, KEY_I, 0x00, KEY_C, 0x00, KEY_P, MODIFIERKEY_SHIFT, KEY_A, 0x00, KEY_R, 0x00, KEY_S, 0x00, KEY_I, 0x00, KEY_N, 0x00, KEY_G, 0x00, KEY_0, MODIFIERKEY_SHIFT, KEY_PERIOD, 0x00, KEY_C, MODIFIERKEY_SHIFT, KEY_O, 0x00, KEY_N, 0x00, KEY_T, 0x00, KEY_E, 0x00, KEY_N, 0x00, KEY_T, 0x00, KEY_QUOTE, MODIFIERKEY_SHIFT
};
